...
export const StoreFront = () => import(/* webpackChunkName: 'StoreFront' */ '@/layout/pages/store-front/store-front.vue');
export const StoreFrontCart = () => import(/* webpackChunkName: 'StoreFront' */ '@/layout/pages/store-front-cart/store-front-cart.vue');
export const DepartmentList = () => import(/* webpackChunkName: 'DepartmentList' */ '@/layout/pages/department-list/department-list.vue');
export const MarketPlace = () => import(/* webpackChunkName: 'MarketPlace' */ '@/layout/pages/market-place/market-place.vue');
...
export default new Router({
  ...
  routes: [
    ...
    {path: '/store-front/:id',  name: 'StoreFrontCart', component: StoreFrontCart},
    {path: '/department-list',  name: 'DepartmentList', component: DepartmentList},
    {path: '/market-place',     name: 'MarketPlace',    component: MarketPlace},
